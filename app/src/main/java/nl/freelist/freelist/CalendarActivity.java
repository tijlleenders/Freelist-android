...
public class CalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarViewModel.getAllEntries().observe(this, new Observer<List<Entry>>() {
            ...
            Toast.makeText(CalendarActivity.this, "calendarViewModel onChanged!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ADD_ENTRY_REQUEST && resultCode == RESULT_OK) {
            Toast.makeText(this, "Entry " + data.getStringExtra(AddEntryActivity.EXTRA_TITLE) + " saved!", Toast.LENGTH_SHORT).show();
        } else {
