...
/**
 * UUIDType5.java Purpose: I couldn't find a uuid-type5 library, so I copied this one from the web.
 *
 * @author User kiskae on StackOverflow
...
public class UUIDType5 {
  ...
  public static UUID nameUUIDFromNamespaceAndString(UUID namespace, String name) {
    return nameUUIDFromNamespaceAndBytes(namespace,
