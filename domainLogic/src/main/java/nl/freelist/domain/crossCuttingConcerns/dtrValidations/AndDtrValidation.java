...
public class AndDtrValidation extends DtrValidation {

  DtrValidation validation1;
  DtrValidation validation2;

  AndDtrValidation(DtrValidation validation1, DtrValidation validation2) {
  ...
  public List<DtrConstraint> list() {
    ...
    dtrConstraintList.add(DtrConstraint.Create("OPERATORAND", null));
